...
import AudioVideoJoinModalContainer from '/imports/ui/components/audio/audio-video-modal/container';
import AudioVideoPreviewContainer from '/imports/ui/components/audio-video-preview/container';
...
class App extends Component {
  constructor(props) {
    ...
    this.setAudioVideoJoinModalIsOpen = this.setAudioVideoJoinModalIsOpen.bind(this);
  ...
  setAudioVideoJoinModalIsOpen(value) {
    this.setState({ isAudioVideoJoinModalOpen: value });
  }
