...
// Smaller label variant used in audio selectors
const LabelSmall = styled(Label)`
  font-size: 0.85rem;
`;

// Full width label variant (kept for compatibility)
const LabelSmallFullWidth = styled(LabelSmall)`
  width: 100%;
`;

// Generic form element wrapper used around controls
...
const AudioVideoPreviewModal = styled(ModalSimple)`
  padding: 1rem;
  min-height: 25rem;
  max-height: 100vh;
